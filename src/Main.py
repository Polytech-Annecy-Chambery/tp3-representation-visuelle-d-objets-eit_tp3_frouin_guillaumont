...
def Q1b_f():
    return Configuration({'screenPosition': -10, 'xAxisColor': [1, 1, 0]}). \
...
def Q4a():
    ...
    wall1 = Wall({'position': [0, 0, 0], 'width' : 7, 'height' : 3, 'orientation' : 0, 'edges' : True})
    wall2 = Wall({'position': [0, 0, 0], 'width' : 3, 'height' : 3, 'orientation' : 90, 'edges' : True})
    wall3 = Wall({'position': [0, 1.4, 0], 'width' : 7, 'height' : 3, 'orientation' : 0, 'edges' : True})
    wall4 = Wall({'position': [0, -3.6, 0], 'width' : 3, 'height' : 3, 'orientation' : 90, 'edges' : True})  
    house = House({'position': [0, 1, 0], 'orientation':0})
    house.add(wall1).add(wall3).add(wall4).add(wall2)
    return Configuration().add(house)   
    
def Q5a():  
    # Ecriture avec mélange de variable et de chaînage    
    opening1 = Opening({'position': [0, 0, 0], 'width':0.9, 'height':2.15, 'thickness':0.2, 'color': [0.7, 0.7, 0.7]})
    opening2 = Opening({'position': [2, 0, 1], 'width':1.25, 'height':1, 'thickness':0.2, 'color': [0.7, 0.7, 0.7]})    
